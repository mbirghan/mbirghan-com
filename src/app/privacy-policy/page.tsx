...
export default function PrivacyPolicy() {
  return (
    <SimpleLayout
      title="Datenschutz&shy;erkl&auml;rung"
      intro="This is a privacy policy for my website. It explains how I handle your data. It is in German to comply with the GDPR."
    >
